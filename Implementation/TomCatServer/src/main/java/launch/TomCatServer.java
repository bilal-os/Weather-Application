...
public class TomCatServer {
    ...
    private static File getRootFolder() {
        try {
            File root;
            String runningJarPath = TomCatServer.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath().replaceAll("\\\\", "/");
    ...
    public static void launchServer() throws Exception {
        ...
        File webContentFolder = new File(root.getAbsolutePath(), "src/main/GUIInterface_war_exploded/");
